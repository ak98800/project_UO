from ._anvil_designer import VueDescendateView_copyTemplate
from anvil import *
...
class VueDescendateView_copy(VueDescendateView_copyTemplate):
  ...
  def _afficher_organigramme(self):
    ...
    if self.societe_point_depart:
      relations = anvil.server.call(
        "get_relations_descendantes", dossier_name, self.societe_point_depart
      )
    else:
